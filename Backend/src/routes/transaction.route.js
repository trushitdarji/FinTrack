...
transactionRoute.post(
  ...
  transactionController.AddTransactionController,
);
transactionRoute.get(
  "/transaction",
  authMiddleware,
  transactionController.FetchTransactionsController,
);
// transactionRoute.get("/transaction/filter",authMiddleware,transactionController.FilterController)
transactionRoute.get(
  "/transaction/summary",
  authMiddleware,
  transactionController.TransactionSummaryController,
);
transactionRoute.get(
  "/transaction/:id",
  authMiddleware,
  transactionController.FetchTransactionByIdController,
);
transactionRoute.put(
  "/transaction/:id",
  authMiddleware,
  transactionController.UpdateTransacationController,
);
